...
function showNextBtn(tooltipT,fromResize){
  ...
  switch (tooltipT) {
    case 'tooltipA':
      ...
      break;
    case 'tooltipB':
    var x1 = 82.5, y1 = 18, tout = 200;
    var x2 = 58, y2 = 18, tout = 200;
      if(window.innerWidth <= 768){
        x1 = 89, y1 = 13, tout = 200;
        x2 = 54, y2 = 13, tout = 200;
      }
      break;
    case 'tooltipC':
...
function chart5ShowToolTipB() {
  var tooltipW = 474,tooltipH = 338,tooltipPadT = 5,tooltipPadR = 221,tooltipX = 32,tooltipY = 43;
  var fcCallout2Img = 'fc-callout2.png';
  
  if(window.innerWidth <= 768) {
      tooltipW = 548,tooltipH = 370,tooltipPadT = 10,tooltipPadR = 190,tooltipX = 31.5,tooltipY = 48;
...
function chart5ShowToolTipC() {
  var tooltipW = 390,tooltipH = 270,tooltipPadT = 82,tooltipPadR = 145,tooltipX = 26,tooltipY = 47.5;
  if(window.innerWidth <= 768) {
