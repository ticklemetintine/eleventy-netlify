...
var icEUAssetPath = "/ed/IndexCurves-EU/en/";
// var icEUAssetPath = "./";
...
chartICEUsvg.append("line")
    ...
    .attr("x1", 288)     // x position of the first end of the line
    .attr("y1", height + 50)      // y position of the first end of the line
    .attr("x2", 318)     // x position of the second end of the line
    .attr("y2", height + 50);    // y position of the second end of the line
chartICEUsvg.append("text")
    .text("Low Ambition Climate Change (Eurozone)")
    .attr("x", 323)
    .attr("y", height + 55)
...
chartICEUsvg.append("text")
  .text("High Ambition Climate Change (Eurozone)")
  // .style("stroke", "#40e0d0")
  .attr("x", 95)
  .attr("y", height + 85)
