...
var trsmvAssetPath = "/ed/tsrmv-chart/en/";
// var trsmvAssetPath = "./";
...
let tr = {
    "trsm" : {
        "data" : [
            ...
            {label:"Since 1974", text:"14",value:14.50}
        ],
        "title" : "S$ Total Shareholder Return by market value",
        "description" : "TSR by market value takes into account changes in the market value of our portfolio, dividends we paid, and nets off any new capital we received."
    },
    "rac" : {
        "data" : [
            ...
            {label:"Since 1974",text:"9", value:9.06}
        ],
        "title" : "Risk-adjusted cost of capital",
        "description" : "Our risk-adjusted cost of capital accounts for different risks faced by our investments, and is derived using a capital asset pricing model. The risk‑adjusted cost of capital is built bottom‑up, and aggregated across all our investments."
    },
    "tsr" : {
        "data" : [
            ...
            {label:"Since 1974", text:"13",value:13.49}
        ],
        "title" : "S$ Total Shareholder Return by shareholder equity",
        "description" : "TSR by shareholder equity takes into account the underlying profitability of our portfolio companies, realised returns from our investment activities, dividends we paid, and nets off any new capital we received."
    },
    "msci" : {
        "title" : "MSCI Indices"
    },
    "mcis" : {
        "data" : [
            ...
            {label:"Since 1974",text:"7", value:7.22}
        ],
        "title" : "MSCI Singapore",
        "description" : "The MSCI Singapore Index measures the performance of large to mid sized companies in Singapore’s stock market."
    ...
    "mcia" : {
        "data" : [
            ...
            {label:"Since 1974",text:"NA", value:0}
        ],
        "title" : "MSCI AC Asia ex-Japan",
        "description" : "The MSCI AC Asia ex-Japan Index measures the performance of large to mid sized companies in Asia, excluding Japan."
    },
    "mciw" : {
        "data" : [
            ...
            {label:"Since 1974", text:"8",value:8.34}
        ],
        "title" : "MSCI World",
        "description" : "The MSCI World Index measures the performance of large to mid sized companies across 23 developed markets in the world."
    }
}
...
function displayTitle() {
    ...
    ul.selectAll('li.tsr')
        ...
        .html("Computed based on shareholder equity excluding mark to market movement of sub-20% investments.")
}
...
function resizeChartSize() {
	...
	svg.select('text.axis-label')
		.attr("dy",
			function(d) { if(window.innerWidth > 425 && window.innerWidth <= 768){ return 30 + 'em'; }
						  if(window.innerWidth <= 425){ return 32.1 + 'em'; }
						  else { return 34.5 + 'em'; } })
	...
	svg.select('line.axis-label-line')
	  ...
	  .attr("y1", function(d) { if(window.innerWidth > 425 && window.innerWidth <= 768){ return 362; }
						  else if(window.innerWidth <= 425){ return 356; }
						  else { return 486; }  })
	  //.attr("x2", -13)
	  .attr("x2", function(d) { if(window.innerWidth > 425 && window.innerWidth <= 768){ return -50; }
						  else if(window.innerWidth <= 425){ return -14; }
						  else { return -13; } })
...
if(window.innerWidth > 425 && window.innerWidth <= 768){ yAxisLabeldy = 30; }
else if(window.innerWidth <= 425){ yAxisLabeldy = 32.1; }
else{ yAxisLabeldy = 34.5; }
...
if(window.innerWidth > 425 && window.innerWidth <= 768) {
  ...
  periodYearTooltip.append("svg:image")
    ...
    .attr("width", 125)
    .attr("xlink:href", trsmvAssetPath + 'tsrmv-tooltip.png')
    .style("opacity", "0")
