...
var tgem4AssetPath = "/ed/t-gem-chart4/en/";
// var tgem4AssetPath = "./";
...
function chart4RemoveToolTipA() {
  ...
  chart4svg.select("#chart4TemToolTipATextE").remove();
}
...
function chart4ShowToolTipA() {
  chart4ShowToolTip({
    ...
    rectYCoor: chart4y(36.5),
    width: 400,
    textColor: "black",
    dotted: true,
    outlineColor: chart4ColorChina,
    textValueLineA: "Central Scenario with",
    textValueLineB: "slightly higher likelihood",
    textValueLineC: "of higher returns, except",
...
function chart4ShowToolTip(params) {
  ...
  aToolTip.append("svg:image")
    ...
    .attr("x", params.rectXCoor+3)
    .attr("y", params.rectYCoor-10)
    .attr("height", 147)    // set the height
    .attr("width", 225)
    .attr("xlink:href", tgem4AssetPath + "chart4-callout1.png")
    .attr("clip-path", "url(#" + params.maskClipId + ")");
  aToolTip
    .append("text")
    .attr("id", params.toolTipId + "TextA")
    .attr("x", params.rectXCoor + 23)
    .attr("y", params.rectYCoor + 15)
