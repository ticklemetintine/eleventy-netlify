...
// var fcAssetPath = "/ed/fundamental/en/";
var fcAssetPath = "./";
...
function createNextBtn(x,y){
  ...
  var nextBtnW = 30, nextBtnH = 30, nextBtnX = 40, nextBtnY = 20;
  if(window.innerWidth <= 768){
      nextBtnW = 40, nextBtnH = 40, nextBtnX = 60, nextBtnY = 26;
  }
...
function createReplayBtn(x,y){
  ...
  if(window.innerWidth <= 768){
      replayBtnW = 40, replayBtnH = 40, replayBtnX = 80, replayBtnY = 26;
  }
...
function showNextBtn(tooltipT,fromResize){
  ...
  switch (tooltipT) {
    case 'tooltipA':
      var x1 = 89, y1 = 48.5, tout = 600;
      if(window.innerWidth <= 768){
        x1 = 88, y1 = 40, tout = 600;
      }
      break;
    case 'tooltipB':
    var x1 = 63, y1 = 14.5, tout = 200;
    var x2 = 38.5, y2 = 14.5, tout = 200;
      if(window.innerWidth <= 768){
        x1 = 75, y1 = 19.5, tout = 200;
        x2 = 39, y2 = 19.5, tout = 200;
      }
      break;
    case 'tooltipC':
      var x1 = 67, y1 = 16, tout = 900;
      var x2 = 43, y2 = 16, tout = 900;
      if(window.innerWidth <= 768){
        x1 = 86.5, y1 = 8.5, tout = 900;
        x2 = 51, y2 = 8.5, tout = 900;
      }
      break;
    case 'tooltipD':
      var x1 = 89.5, y1 = 28.5, tout = 500;
      var x2 = 61, y2 = 28.5, tout = 500;
      if(window.innerWidth <= 768){
        x1 = 92, y1 = 16.5, tout = 500;
        x2 = 51.2, y2 = 16.5, tout = 500;
      }
      break;
    case 'tooltipE':
      var x1 = 90.5, y1 = 31, tout = 1700;
      var x2 = 69.5, y2 = 31, tout = 1700;
      if(window.innerWidth <= 768){
        x1 = 89, y1 = 17, tout = 1700;
        x2 = 56.5, y2 = 17, tout = 1700;
      }
      break;
    case 'tooltipF':
      var x1 = 93, y1 = 17.5, tout = 1800;
      var x2 = 62, y2 = 17.5, tout = 1800;
      if(window.innerWidth <= 768){
        x1 = 92, y1 = 8, tout = 1800;
        x2 = 45.7, y2 = 8, tout = 1800;
      }
      break;
  }
...
function chart5ShowToolTipA() {
  ...
  chart5ShowToolTip({
    ...
    textValue: "Over time, our portfolio value is|projected to grow at our expected|base case rate of return.",
...
function chart5ShowToolTipB() {
  var tooltipW = 300,tooltipH = 290,tooltipPadT = 5,tooltipPadR = 30,tooltipX = 35,tooltipY = 38;
  if(window.innerWidth <= 768) {
      tooltipW = 420,tooltipH = 420,tooltipPadT = 20,tooltipPadR = 35,tooltipX = 35,tooltipY = 54;
  }
  chart5ShowToolTip({
    ...
    dotted: false,
    outlineColor: colorRed,
    textValue: "We evaluate the potential for sustained|portfolio loss and use different stress|scenarios across geographies and|events to test our portfolio resilience.| |The red line illustrates how our|projections might change if a stress|event were to occur.",
    maskClipId: "chart5MaskClip3",
    calloutImg: 'fc-callout2.png',
    textPaddingTop: tooltipPadT,
    textPaddingRight: tooltipPadR
  });
}
...
function chart5ShowToolTipC() {
  var tooltipW = 390,tooltipH = 270,tooltipPadT = 82,tooltipPadR = 145,tooltipX = 26,tooltipY = 47;
  if(window.innerWidth <= 768) {
  ...
  chart5ShowToolTip({
    ...
    dotted: false,
    outlineColor: colorRed,
    textValue: "In a stress event, our portfolio value|will likely be affected by the market’s|overreaction and increased risk|aversion in the short term.| |The full extent of this is shown by the|trough impact.",
...
function chart5ShowToolTipD() {
  var tooltipW = 290,tooltipH = 210,tooltipPadT = 70,tooltipPadR = 10,tooltipX = 60,tooltipY = 52;
  if(window.innerWidth <= 768) {
      tooltipW = 410,tooltipH = 310,tooltipPadT = 105,tooltipPadR = 13,tooltipX = 50,tooltipY = 51;
  }
  chart5ShowToolTip({
    ...
    dotted: false,
    outlineColor: colorRed,
    textValue: "However, this is only temporary. Looking|back at past episodes of market stress,|markets typically recover from the trough|and normalise after the stress event is over.",
...
function chart5ShowToolTipE() {
  ...
  if(window.innerWidth <= 768) {
      tooltipW = 430,tooltipH = 350,tooltipPadT = 130,tooltipPadR = 60,tooltipX = 50,tooltipY = 58;
  }
  chart5ShowToolTip({
    ...
    dotted: false,
    outlineColor: colorRed,
    textValue: "Over time, we expect our portfolio|value to return to the previous|growth rate, but from a lower|starting point as a result of a|major stress event.",
...
function chart5ShowToolTipF() {
  var tooltipW = 320,tooltipH = 285,tooltipPadT = 80,tooltipPadR = 15,tooltipX = 60.5,tooltipY = 52,calloutImg = 'fc-callout6.png';
  if(window.innerWidth <= 768) {
      tooltipW = 470,tooltipH = 400,tooltipPadT = 115,tooltipPadR = 15,tooltipX = 43.5,tooltipY = 55.5,calloutImg = 'fc-callout7.png';
  }
  chart5ShowToolTip({
    ...
    dotted: false,
    outlineColor: colorRed,
    textValue: "This difference is the sustained fundamental|earnings impact on our portfolio value, which|we focus on when managing our portfolio.| |Bad times are inevitable. However,|understanding the potential impact of various|stress events on our portfolio helps us to plan|ahead on how to react in a stress event.",
...
function chart5ShowToolTip(params) {
  ...
  var textYM = (window.innerWidth <= 768) ? 28 : 20;
...
function chart5ShowLabelA() {
  showMultiLineLabel({
    ...
    rectXCoor: chart5x(17),
    rectYCoor: chart5y(45.5),
    width: 60,
    height: 50,
    dotted: false,
    outlineColor: colorRed,
    textValue: "Trough|Impact",
...
function chart5ShowLabelB() {
  showMultiLineLabel({
    ...
    rectXCoor: chart5x(54),
    rectYCoor: chart5y(60),
    width: 60,
    height: 50,
    dotted: false,
    outlineColor: colorRed,
    textValue: "End of|stress event",
  ...
  function chart5ShowLabelC() {
    showMultiLineLabel({
      ...
      rectYCoor: chart5y(46.3),
      width: 60,
      height: 50,
      dotted: false,
      outlineColor: colorRed,
      textValue: "Fundamental|Earnings Impact",
...
function showMultiLineLabel(params) {
  ...
  aLabelText
      .append("text")
      .attr("x", params.rectXCoor + params.textPaddingRight2)
      .attr("y", y + params.textPaddingTop + textYM)
      .text(textArr[1])
      .attr("class", params.labelId + " chartLabel" )
      .style("text-anchor", "start")
      .attr("clip-path", "url(#" + params.maskClipId + ")")
      .attr("transform", "rotate("+ params.rotate2 +")");


}

d3.selectAll("#testHover").on("click",function(){
  alert('test')
})
