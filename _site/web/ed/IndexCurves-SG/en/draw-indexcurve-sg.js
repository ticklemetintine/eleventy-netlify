...
var icSGAssetPath = "/ed/IndexCurves-SG/en/";
// var icSGAssetPath = "./";
...
chartICSGsvg.append("line")
    ...
    .attr("x1", 298)     // x position of the first end of the line
    .attr("y1", height + 50)      // y position of the first end of the line
    .attr("x2", 328)     // x position of the second end of the line
    .attr("y2", height + 50);    // y position of the second end of the line
chartICSGsvg.append("text")
    .text("Low Ambition Climate Change (Singapore)")
    .attr("x", 333)
    .attr("y", height + 55)
...
chartICSGsvg.append("text")
  .text("High Ambition Climate Change (Singapore)")
  // .style("stroke", "#40e0d0")
  .attr("x", 95)
  .attr("y", height + 85)
